...
public class SessionManager {
    ...
    private static final String KEY_USER_SIGN = "userSign";
    ...
    public String getUserSign(){
        return pref.getString(KEY_USER_SIGN, "");
    }

    public void setUserSign(String sign) {
        pref.edit().putString(KEY_USER_SIGN, sign).apply();
    }
    ...
    public User getUser() {
        return isLogin() ? new User(getUserId(), getUserNickname(), getUserSign(), getUserAvatar()) : null;
    }
