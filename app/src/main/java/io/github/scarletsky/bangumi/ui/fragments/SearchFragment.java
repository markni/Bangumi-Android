...
public class SearchFragment extends Fragment {
    ...
    private void toggleSoftKeyboard(boolean hide) {
        InputMethodManager mInputMethodManager =  ((InputMethodManager) getActivity().getSystemService(getContext().INPUT_METHOD_SERVICE));
        if (hide){
            mInputMethodManager.hideSoftInputFromWindow(getActivity().getCurrentFocus().getWindowToken(), 0);
        }
        else{
            //// TODO: 12/27/2015 Why have to use toggle? 
